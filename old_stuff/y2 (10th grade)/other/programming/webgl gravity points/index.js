var vertex = `#version 300 es
    ...
    uniform PointData{
        vec3 positions [numPoints];
        vec3 velocities [numPoints];
    };
...
var generalData = new Float32Array(2);
var generalUniformBuffer;
...
function LoadStuff() {
    ...
    for (var i = 0; i < numPoints; ++i) {
        ...
        //velocityData[index] = Math.random() * 0.02 - 0.01;
        //velocityData[index + 1] = Math.random() * 0.02 - 0.01;
    ...
    //uniforms
    var generalUniformsLocation = gl.getUniformBlockIndex(shader, "General");
    gl.uniformBlockBinding(shader, generalUniformsLocation, 0);

    generalData = new Float32Array(2);
    generalData[0] = window.innerWidth;
    generalData[1] = window.innerHeight;

    generalUniformBuffer = gl.createBuffer();
    gl.bindBufferBase(gl.UNIFORM_BUFFER, 0, generalUniformBuffer);
    gl.bufferData(gl.UNIFORM_BUFFER, generalData, gl.DYNAMIC_DRAW)


    var PointDataUniformsLocation = gl.getUniformBlockIndex(shader, "PointData");
    gl.uniformBlockBinding(shader, PointDataUniformsLocation, 0);

    //pointDataUniformBuffer = gl.createBuffer();
